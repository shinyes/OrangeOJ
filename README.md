...
- 创建作业时支持直接导入题目 JSON 数组，自动建题并建作业
- 创建训练时支持按章节导入题目 JSON 数组，自动建题并挂到对应章节
- 作业与训练共用题目草稿 JSON 校验工具，导入行为一致
- 作业页顶栏进一步简化，模式与操作入口压缩到单行

查看详情：[RELEASE_v0.5.9.md](./RELEASE_v0.5.9.md)
