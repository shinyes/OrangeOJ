...
- 修复作业/训练通过 JSON 导入选择题时答案字段口径不一致的问题
- 选择题答案导入支持 `answer`、`correctIndex`、`answerIndex`、`correctLabel` 等写法
- 编辑题目时旧数据也能按选项文本正确回显答案
- 客观题判题兼容历史导入数据，避免答案被误判或回退到首个选项

查看详情：[RELEASE_v0.5.11.md](./RELEASE_v0.5.11.md)
