...
func NewApp(db *sql.DB, jwtSecret string, cookieSecure bool, corsOrigins string) *fiber.App {
	...
	spaceRead.Get("/problems/tags", api.handleGetProblemTags)
	...
	spaceRead.Get("/problem-directories/counts", api.handleGetProblemDirectoryCounts)
	...
	protected.Put("/spaces/:spaceId/problems/:problemId/solutions", auth.RequireSpaceAdmin(db), api.handleUpdateProblemSolutions)
